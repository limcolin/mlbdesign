...
<!--Fonts-->
<link href='http://fonts.googleapis.com/css?family=Fira+Sans:400,700,300' rel='stylesheet' type='text/css'>
						...
						<ul class="buttons" data-user-set-ocm="<?php echo $userSetSideWidgetArea; ?>">
							...
							<?php if($sideWidgetArea == '1') { ?>
								<li class="slide-out-widget-area-toggle">
									<div><a id="nav-toggle" href="#sidewidgetarea" class="closed"><span></span><p class="menu-text">MENU</p></a><!--<span> <i class="lines-button x2"> <i class="lines"></i> </i> </span>--></a> </div> 
       							</li>
							<?php } ?>
						</ul>
						<ul class="sf-menu">	
